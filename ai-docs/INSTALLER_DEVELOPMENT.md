...
This guide covers the development workflow for installer.
...
```bash
git clone https://github.com/openshift-splat-team/installer.git
cd installer
```
...
# Or with podman
podman build -t installer:latest .
```
...
- [Testing Guide](installer_TESTING.md) - Test suites and strategies
