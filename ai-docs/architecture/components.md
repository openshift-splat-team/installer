...
This document describes the major components and architecture of installer.
...
- [Development Guide](../installer_DEVELOPMENT.md) - How to build and run
- [Testing Guide](../installer_TESTING.md) - How to test components
