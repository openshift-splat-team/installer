# installer Ecosystem and References
...
This document provides links to related projects, upstream dependencies, documentation, and external resources relevant to installer.
...
**Relationship:** installer runs on Kubernetes
...
**Relationship:** installer is part of OpenShift platform
...
Key libraries and frameworks used by installer:
...
- [Development Guide](../installer_DEVELOPMENT.md) - Build and develop
- [Testing Guide](../installer_TESTING.md) - Test suites
